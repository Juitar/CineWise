...
export const BrandLogoIcon: React.FC<{ size?: number; className?: string }> = ({
  ...
  >
    ...
    <path
      d="M12 8C9.79086 8 8 9.79086 8 12V22C8 28.6274 13.3726 34 20 34C26.6274 34 32 28.6274 32 22V12C32 9.79086 30.2091 8 28 8C25.7909 8 24 9.79086 24 12V21C24 23.2091 22.2091 25 20 25C17.7909 25 16 23.2091 16 21V12C16 9.79086 14.2091 8 12 8Z"
      fill="url(#logoGrad)"
    />
  </svg>
);
