...
describe('resolveBrowserCity', () => {
  ...
  it('normalizes high precision browser coordinates before validation', async () => {
    await expect(resolveBrowserCity(112.93881460000001, 28.228208500000004)).resolves.toBe('长沙市');
    expect(api.apiRequest).toHaveBeenCalledWith('/api/v1/agent/location/city', expect.objectContaining({
