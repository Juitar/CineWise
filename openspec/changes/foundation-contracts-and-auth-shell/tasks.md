...
- [x] A已于2026-08-02对照票务交易详设确认T13-T20的全部字段、状态、条件更新、幂等键、金额快照和不物理删除规则。
...
- [x] A已为T09-T10、T13-T20建立feature OpenSpec并分配V001-V003；Flyway默认保持关闭。
- [x] T09-T10已由D确认、T13-T20已由A确认；V001-V003已完成本地预演和云端MySQL 8.4.11正式迁移验证。
